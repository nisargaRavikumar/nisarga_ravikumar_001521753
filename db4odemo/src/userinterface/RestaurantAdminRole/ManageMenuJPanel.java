...
public class ManageMenuJPanel extends javax.swing.JPanel {
    ...
    private void btnAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddItemActionPerformed
        ...
        for (dishes item : restaurant.getCatalog().getDishesList()) {
        ...
        dishes item = new dishes(itemName.getText(), Double.valueOf(itemPrice.getText()));

        // ecosystem.getItemList().addItem(item);
        restaurant.getCatalog().addtodishesList(item);
        populateTable();
        itemName.setText("");
        itemPrice.setText("");
    ...
    private void btnUpdateItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateItemActionPerformed
        ...
        if (selectedRow >= 0) {
            String name = (String) tblMenu.getValueAt(selectedRow, 0);
                    double price = (Double) tblMenu.getValueAt(selectedRow, 1);
                    dishes item = new dishes(name,price);
            item.setName(itemName.getText());
            item.setAmount(Double.valueOf(itemPrice.getText()));
            populateTable();
            itemName.setText("");
            itemPrice.setText("");
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (dishes item : menu.getDishesList()) {
    ...
    private void display(dishes item) {
        itemName.setText(item.getName());
        itemPrice.setText(Double.valueOf(item.getAmount()) + "");
